...
module.exports = async (self, app, metadata) => {
  ...
  await iniciar.click()
  await sleep(20000)
  Pupt.click(page,'.GNVPVGB-Gi-e:nth-of-type(1) [type]')
  await sleep(2000)
  Pupt.click(page,'.GNVPVGB-Gi-e:nth-of-type(2) [type]')
  await sleep(2000)
  Pupt.click(page,"span:nth-of-type(3) > input[value='on']")
  await sleep(2000)
  let proximo = await Pupt.$byText(page, 'Next')
  await proximo.click()
  await sleep(2000)
  Pupt.click(page, ".GNVPVGB-Ji-l .GNVPVGB-Ji-k:nth-of-type(2) [type]", 1)
